...
rawData = read.csv('Data/Data_CC_tense_20Jan2017.csv', as.is=T) 
```
...
# Check all papers have full geographic extent information
table(df$geographic_extent_of_study)
...
# Check focus of study is filled correctly
